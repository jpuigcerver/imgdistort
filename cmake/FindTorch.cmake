...
FIND_LIBRARY(TORCH_THC_LIBRARY
  NAMES THC
  HINTS ${TORCH_ROOT}/lib ${TORCH_BIN_PATH}/../lib)
MARK_AS_ADVANCED(TORCH_THC_LIBRARY)

FIND_PACKAGE_HANDLE_STANDARD_ARGS(TORCH
  DEFAULT_MSG TORCH_ROOT TORCH_BIN_PATH TORCH_LUALIB_PATH TORCH_LUA_PATH
  TORCH_INCLUDE_DIR TORCH_LUAT_LIBRARY TORCH_TH_LIBRARY)
...
IF (TORCH_FOUND)
  ...
  ENDIF (TORCH_LUAJIT_LIBRARY)
  LIST(APPEND TORCH_LIBRARIES "${TORCH_LUAT_LIBRARY}" "${TORCH_TH_LIBRARY}")
  IF (TORCH_THC_LIBRARY)
    LIST(APPEND TORCH_LIBRARIES "${TORCH_THC_LIBRARY}")
    SET(WITH_CUTORCH ON)
  ELSE (TORCH_THC_LIBRARY)
    SET(WITH_CUTORCH OFF)
  ENDIF ()
ENDIF()
